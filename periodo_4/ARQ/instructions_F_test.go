...
var _ = Describe("InstructionsF", func() {
	...
	Describe("Sub", func() {
		...
		When("Result has carry", func() {
			...
			Context("#Print", func() {
				It("Should view return instruction with ZN in SR toggle", func() {
					...
					Expect(string(message)).To(Equal("0x00000008:\tsub r3,r1,r2             \tR3=R1+R2=0x00002345,SR=0x00000001\n"))
				})
			})
		})
		...
		// 			Expect(string(message)).To(Equal("0x00000008:\tsub r3,r1,r2             \tR3=R1+R2=0x80012345,SR=0x00000010\n"))
		// 		})
		// 	})
		// })
